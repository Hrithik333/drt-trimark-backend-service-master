...
from app.modules.apimodule.typeconfig import metric_type_config
...
class FetchDataService:
    ...
    @staticmethod
    def generate_table_response(data, use_case):
        response = {}
        response1 = {}
        ...
        for k, v in final_response.items():
            ...
            for i, j in v.items():
                count += 1
                formatted_res.append({"id": num2words(count), "name": i, "data": j, "type": metric_type_config[str(use_case)][i]})
